...
final class TraceMongoCommandListener implements CommandListener {
    ...
    public void commandStarted(CommandStartedEvent event) {
        ...
        endpointBuilder.serviceName("mongodb-" + databaseName);
        ...
        if (connectionDescription != null) {
            ...
            try {
                ...
                endpointBuilder.ip(socketAddress.getAddress().getHostAddress());
                endpointBuilder.port(socketAddress.getPort());
            } catch (MongoSocketException ignored) {

            }
        }

        span.remoteEndpoint(endpointBuilder.build());
